            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 484, DateTimeKind.Local).AddTicks(1543),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 483, DateTimeKind.Local).AddTicks(9727),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(2456),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(7601),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(7618),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5642),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5796),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5800),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 12, 12, 21, 43, 15, 483, DateTimeKind.Local).AddTicks(7948),
