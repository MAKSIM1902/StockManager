    ...
    public partial class f : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 12, 12, 21, 43, 15, 483, DateTimeKind.Local).AddTicks(9727), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(2456), "Stock Receipt" },
                    { 2, new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(7601), "Stock Out" },
                    { 3, new DateTime(2022, 12, 12, 21, 43, 15, 470, DateTimeKind.Local).AddTicks(7618), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5642), "pc", "Piece" },
                    { 2, new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5796), "kg", "Kilogram" },
                    { 3, new DateTime(2022, 12, 12, 21, 43, 15, 471, DateTimeKind.Local).AddTicks(5800), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2022, 12, 12, 21, 43, 15, 483, DateTimeKind.Local).AddTicks(7948), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2022, 12, 12, 21, 43, 15, 484, DateTimeKind.Local).AddTicks(1543), null, null, 1m, "Example Product", 1 });
